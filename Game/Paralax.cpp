...
Paralax::Paralax()
{
	...
	m_MediumBg = new sf::Sprite(*ImageManager::RequestTexture("Assets/GraphicalAssets/leve2_midground.png"));
	m_MediumBg2 = new sf::Sprite(*ImageManager::RequestTexture("Assets/GraphicalAssets/level prototype_midground.png"));
	m_Foreground = new sf::Sprite(*ImageManager::RequestTexture("Assets/GraphicalAssets/level2.png"));
