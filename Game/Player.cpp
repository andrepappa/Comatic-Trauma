...
Player::Player()
{
	...
	std::vector<sf::IntRect*> Frames_Run = AnimManager::GetSubRects(199, 328, 8, 8, 0, 0);
	std::vector<sf::IntRect*> Frames_Jump = AnimManager::GetSubRects(199, 328, 1, 8, 1, 1);
	std::vector<sf::IntRect*> Frames_Fall = AnimManager::GetSubRects(199, 328, 1, 8, 2, 1);
	...
	CurrentAnim = IDLE;
	m_GOSprite = new sf::Sprite(*ImageManager::RequestTexture("Assets/GraphicalAssets/test.png"));
